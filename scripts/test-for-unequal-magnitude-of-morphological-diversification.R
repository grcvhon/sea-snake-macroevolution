# R script for test for unequal magnitude of morphological diversification
...
print(quote = FALSE, ">> mean_morphometric_branch_length_AE")
mean.pms3(ext_AE_ultra,morph_trait_data_AE)

# Hydrophis
print(quote = FALSE, ">> mean_morphometric_branch_length_Hyd")
mean.pms3(ext_hyd,morph_trait_data_hyd)

# Calcualte observed M-ratio (observed)
print(quote = FALSE, ">> Observed_M-ratio")
(mean.pms3(ext_hyd,morph_trait_data_hyd))/(mean.pms3(ext_AE_ultra,morph_trait_data_AE))
M_obs <- (mean.pms3(ext_hyd,morph_trait_data_hyd))/(mean.pms3(ext_AE_ultra,morph_trait_data_AE))

print(quote = FALSE, " ")
print(quote = FALSE, "############")
print(quote = FALSE, "Simulations to test for significance")
print(quote = FALSE, "############")
print(quote = FALSE, " ")
...
pdf("hist_Mratio_sim.pdf", height = 8.5, width = 11)
hist((unlist(Msim_hyd))/(unlist(Msim_ae)), main = "", xlab = "M-ratio")
abline(v=1.57, col = "red", lwd = 2)
sum((unlist(Msim_hyd))/(unlist(Msim_ae))>=1.57)/100000
