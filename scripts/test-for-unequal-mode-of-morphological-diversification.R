# R script for test for unequal mode of morphological diversification
...
(sum((raw_D1sim_AE/raw_D1sim_hyd)>=3.754275))/100000 
...
# split for hyd
hyd_log10_new_tips <- splitter2(arr = log10_new_tips, r = c(10:44), c = c(1:2), e = c(1:100000))
# Complete array with colnames and rownames
...
(sum((log10_D1sim_AE/log10_D1sim_hyd)>=1.78))/100000


print(quote = FALSE, " ")
print(quote = FALSE, "##########")
print(quote = FALSE, "Summary")
print(quote = FALSE, "##########")
print(quote = FALSE, " ")

print(quote = FALSE, "### Raw ###")
print(quote = FALSE, ">> lineage density 1_AE")
ldensity1_AE <- sumblen_AE/area_AE 
print(quote = FALSE, " ")
print(quote = FALSE, ">> lineage density 1_hyd")
ldensity1_hyd <- sumblen_hyd/area_hyd 
print(quote = FALSE, " ")
print(quote = FALSE, ">> lineage density 1 ratio")
ldensity1_AE/ldensity1_hyd 
print(quote = FALSE, " ")
print(quote = FALSE, ">> p-value")
(sum((raw_D1sim_AE/raw_D1sim_hyd)>=3.754275))/100000

print(quote = FALSE, " ")
print(quote = FALSE, "### log10 ###")
print(quote = FALSE, ">> log10 lineage density 1_AE")
ldensity1_AElog10 <- sumblen_AElog10/area_AElog10
print(quote = FALSE, " ")
print(quote = FALSE, ">> log10 lineage density 1_hyd")
ldensity1_hydlog10 <- sumblen_hydlog10/area_hydlog10
print(quote = FALSE, " ")
print(quote = FALSE, ">> log10 lineage density 1 ratio")
ldensity1_AElog10/ldensity1_hydlog10
print(quote = FALSE, " ")
print(quote = FALSE, ">> p-value")
(sum((log10_D1sim_AE/log10_D1sim_hyd)>=1.78))/100000
